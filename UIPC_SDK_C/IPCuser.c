...
// Stop the client
DECLDIR void FSUIPC_Close(void)
{	m_hWnd = 0;
	m_msg = 0;
...
DECLDIR BOOL FSUIPC_Open(DWORD dwFSReq, DWORD *pdwResult)
...
DECLDIR BOOL FSUIPC_Process(DWORD *pdwResult)
{	DWORD dwError;
	DWORD *pdw;
...
DECLDIR BOOL FSUIPC_Read(DWORD dwOffset, DWORD dwSize, void *pDest, DWORD *pdwResult)
...
DECLDIR BOOL FSUIPC_Write(DWORD dwOffset, DWORD dwSize, void *pSrce, DWORD *pdwResult)
